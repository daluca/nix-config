...

{
  ...
  xdg.configFile = with pkgs; {
    ...
    "heroic/tools/proton/GE-Proton10-29".source = lib.getOutput "steamcompattool" GE-Proton10-29;
    "heroic/tools/proton/GE-Proton10-28".source = lib.getOutput "steamcompattool" GE-Proton10-28;
