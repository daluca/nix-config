...
let
  ...
  inherit (pkgs) GE-Proton9-27 GE-Proton9-26 GE-Proton9-25 GE-Proton9-24 GE-Proton9-23 GE-Proton9-22 GE-Proton8-32 GE-Proton7-55;
in {
  home.packages = [
    heroic
  ];

  xdg.configFile."heroic/tools/proton/GE-Proton9-27".source = getOutput "steamcompattool" GE-Proton9-27;
