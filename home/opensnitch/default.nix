...
{
  services.opensnitch-ui.enable = lib.mkIf osConfig.services.opensnitch.enable true;
  ...
  systemd.user.services.opensnitch-ui = lib.mkIf osConfig.services.xserver.desktopManager.gnome.enable {
    Unit = {
